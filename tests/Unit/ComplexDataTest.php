...
class ComplexDataTest extends TestCase
{
    ...
    public function handles_unicode_and_special_characters()
    {
        ...
        $this->assertEquals('🚀 Laravel SuperJSON 🎉', $deserialized['emoji']);
        $this->assertEquals('你好世界', $deserialized['chinese']);
        $this->assertEquals('مرحبا بالعالم', $deserialized['arabic']);
